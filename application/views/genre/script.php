<script>
    ...
    var genre = '<?= $this->uri->segment('3'); ?>';
    var page = '<?= $this->uri->segment('5'); ?>';
    ...
    {
        $.ajax({
            url: base_url+`curl/genre/${genre}/${page}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                ...
                if(page == 1)
                {
                    $('#page').html(`<ul class="pagination justify-content-center">
                                        <li class="page-item disabled"><a class="page-link">Previous</a></li>
                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'genre/categories/'+genre+'/page/'+hal+`">`+ hal +`</a></li>
                                        <li class="page-item"><a class="page-link" href="`+ base_url +'genre/categories/'+genre+'/page/'+next+`">`+ next +`</a></li>
                                        <li class="page-item"><a class="page-link" href="`+ base_url +'genre/categories/'+genre+'/page/'+next+`">Next</a></li>
                                    </ul>`);
                }else
                {
                    ...
                    {
                        $('#page').html(`<ul class="pagination justify-content-center">
                                            <li class="page-item"><a class="page-link" href="`+ base_url +'genre/categories/'+genre+'/page/'+prev+`">Previous</a></li>
                                            <li class="page-item"><a class="page-link" href="`+ base_url +'genre/categories/'+genre+'/page/'+prev+`">`+ prev +`</a></li>
                                            <li class="page-item active"><a class="page-link" href="`+ base_url +'genre/categories/'+genre+'/page/'+hal+`">`+ hal +`</a></li>
                                            <li class="page-item"><a class="page-link" href="`+ base_url +'genre/categories/'+genre+'/page/'+next+`">`+ next +`</a></li>
                                            <li class="page-item"><a class="page-link" href="`+ base_url +'genre/categories/'+genre+'/page/'+next+`">Next</a></li>
                                        </ul>`);
                ...
                $.each(data, function(i)
                {
                    ...
                    $('#genre').append(`<div class="col p-1">
    ...
    {
        $('#genre, #recent_movie, #recent_series').on('click', '.trailer', function () {
            var id = $(this).data('id');      
