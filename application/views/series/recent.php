<div class="container mt-3 bg-white">
  <div class="row">
    <div class="col-md-9 mt-2">
      <div class="row">
        <div class="col-md-12">
            <h4 class="ml-2">Kumpulan Series Rilis Terbaru</h4>
            <div id="load" class="text-center"></div>
            <div class="row row-cols-3 row-cols-sm-3 row-cols-md-6 m-1" id="recent_series_content">

            </div>
            <br>
            <nav id="page_recent_series">
