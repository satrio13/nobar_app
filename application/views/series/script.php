<script>
    ...
    {
        $.ajax({
            url: base_url+`curl/latest_series/${page}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                ...
                if(page == 1)
                {
                    $('#page_latest_series').html(`<ul class="pagination justify-content-center">
                                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'series/latest/page/'+hal+`">`+ hal +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/latest/page/'+next+`">`+ next +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/latest/page/'+next+`">Next</a></li>
                                                    </ul>`);
                }else
                {
                    ...
                    {
                        $('#page_latest_series').html(`<ul class="pagination justify-content-center">
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/latest/page/'+prev+`">Previous</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/latest/page/'+prev+`">`+ prev +`</a></li>
                                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'series/latest/page/'+hal+`">`+ hal +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/latest/page/'+next+`">`+ next +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/latest/page/'+next+`">Next</a></li>
                                                    </ul>`);
    ...
    {
        $.ajax({
            url: base_url+`curl/popular_series/${page}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                ...
                if(page == 1)
                {
                    $('#page_popular_series').html(`<ul class="pagination justify-content-center">
                                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'series/popular/page/'+hal+`">`+ hal +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/popular/page/'+next+`">`+ next +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/popular/page/'+next+`">Next</a></li>
                                                    </ul>`);
                }else
                {
                    ...
                    {
                        $('#page_popular_series').html(`<ul class="pagination justify-content-center">
                                                            <li class="page-item"><a class="page-link" href="`+ base_url +'series/popular/page/'+prev+`">Previous</a></li>
                                                            <li class="page-item"><a class="page-link" href="`+ base_url +'series/popular/page/'+prev+`">`+ prev +`</a></li>
                                                            <li class="page-item active"><a class="page-link" href="`+ base_url +'series/popular/page/'+hal+`">`+ hal +`</a></li>
                                                            <li class="page-item"><a class="page-link" href="`+ base_url +'series/popular/page/'+next+`">`+ next +`</a></li>
                                                            <li class="page-item"><a class="page-link" href="`+ base_url +'series/popular/page/'+next+`">Next</a></li>
                                                        </ul>`);
                    ...
                    $('#popular_series').append(`<div class="col p-1">
                                                    <div class="card h-100">
                                                        ...
                                                        <div class="text-center mb-1">
                                                            ...
                                                            <h6 class="mt-1 text-danger d-block d-sm-none" style="font-size: 7pt">`+ genre.replace(/,/g,', ') +`</h6>
                                                            <div class="d-none d-sm-block">
                                                                <a href="#" data-toggle="modal" data-target="#modal_trailer" data-id="`+ data[i]._id+`" class="btn btn-primary btn-sm trailer" style="padding: 2px;font-size: 9pt;">Trailer</a>
                                                                <a href="`+ base_url +`series/watch/`+ data[i]._id +`" class="btn btn-danger btn-sm" style="padding: 2px; font-size: 9pt;">Series</a>
                                                            </div>
                                                            <div class="d-block d-sm-none">
                                                                <a href="#" data-toggle="modal" data-target="#modal_trailer" data-id="`+ data[i]._id+`" class="btn btn-primary btn-sm trailer" style="padding: 2px;font-size: 7pt;">Trailer</a>
                                                                <a href="`+ base_url +`series/watch/`+ data[i]._id +`" class="btn btn-danger btn-sm" style="padding: 2px; font-size: 7pt;">Series</a>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    {
        $.ajax({
            url:  base_url+`curl/recent_series/${page}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                ...
                if(page == 1)
                {
                    $('#page_recent_series').html(`<ul class="pagination justify-content-center">
                                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'series/recent-release/page/'+hal+`">`+ hal +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/recent-release/page/'+next+`">`+ next +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'series/recent-release/page/'+next+`">Next</a></li>
                                                    </ul>`);
                }else
                {
                    ...
                    {
                        $('#page_recent_series').html(`<ul class="pagination justify-content-center">
                                                            <li class="page-item"><a class="page-link" href="`+ base_url +'series/recent-release/page/'+prev+`">Previous</a></li>
                                                            <li class="page-item"><a class="page-link" href="`+ base_url +'series/recent-release/page/'+prev+`">`+ prev +`</a></li>
                                                            <li class="page-item active"><a class="page-link" href="`+ base_url +'series/recent-release/page/'+hal+`">`+ hal +`</a></li>
                                                            <li class="page-item"><a class="page-link" href="`+ base_url +'series/recent-release/page/'+next+`">`+ next +`</a></li>
                                                            <li class="page-item"><a class="page-link" href="`+ base_url +'series/recent-release/page/'+next+`">Next</a></li>
                                                        </ul>`);
                ...
                $.each(data, function(i)
                {
                    ...
                    var genres = data[i].genres;
                    var genre = String(genres);
                    $('#recent_series_content').append(`<div class="col p-1">
                                                    <div class="card h-100">
                                                        <img src="`+ img +`" class="card-img-top">
                                                        <div class="bg-success text-white pl-1 pr-1" style="font-size: 9pt">
                                                            `+ rating +`
    ...
    {
        $('#latest_series, #popular_series, #recent_series_content, #recent_movie, #recent_series').on('click', '.trailer', function () {
            var id = $(this).data('id');      
