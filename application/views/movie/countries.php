<div class="container mt-3 bg-white">
  <div class="row">
    <div class="col-md-9 mt-2">
      <div class="row">
        <div class="col-md-12">
            <h4 class="ml-2">Kumpulan Film Terbaru dan Terlengkap dari Negara <?= ucwords($this->uri->segment('3')); ?></h4>
            <div id="load" class="text-center"></div>
            <div class="row row-cols-3 row-cols-sm-3 row-cols-md-6 m-1" id="countries">

            </div>
            <br>
            <nav id="page_countries">
