<script>
    ...
    function handle_top_movie()
    {
        $.ajax({
            url: base_url+`curl/top_rated_movies/${page}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                $("#load").html('');
                var hal = page;
                var prev = Number(hal) - 1;
                var next = Number(hal) + 1;
                var img, title, rating;
                if(page == 1)
                {
                    $('#page_top_movie').html(`<ul class="pagination justify-content-center">
                                                    <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/top-rated/page/'+hal+`">`+ hal +`</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/top-rated/page/'+next+`">`+ next +`</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/top-rated/page/'+next+`">Next</a></li>
                                                </ul>`);
                }else
                {
                    ...
                    {
                        $('#page_top_movie').html(`<ul class="pagination justify-content-center">
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/top-rated/page/'+prev+`">Previous</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/top-rated/page/'+prev+`">`+ prev +`</a></li>
                                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/top-rated/page/'+hal+`">`+ hal +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/top-rated/page/'+next+`">`+ next +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/top-rated/page/'+next+`">Next</a></li>
                                                    </ul>`);
                ...
                $.each(data, function(i)
                {
                    ...
                    $('#top_movie').append(`<div class="col p-1">
    ...
    function handle_latest_movie()
    {
        $.ajax({
            url: base_url+`curl/latest_movies/${page}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                ...
                if(page == 1)
                {
                    $('#page_latest_movie').html(`<ul class="pagination justify-content-center">
                                                    <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/latest/page/'+hal+`">`+ hal +`</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/latest/page/'+next+`">`+ next +`</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/latest/page/'+next+`">Next</a></li>
                                                </ul>`);
                }else
                {
                    ...
                    {
                        $('#page_latest_movie').html(`<ul class="pagination justify-content-center">
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/latest/page/'+prev+`">Previous</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/latest/page/'+prev+`">`+ prev +`</a></li>
                                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/latest/page/'+hal+`">`+ hal +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/latest/page/'+next+`">`+ next +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/latest/page/'+next+`">Next</a></li>
                                                    </ul>`);
                ...
                $.each(data, function(i)
                {
                    ...
                    var genres = data[i].genres;
                    var genre = String(genres);
                    $('#latest_movie').append(`<div class="col p-1">
                                                    <div class="card h-100">
                                                        <img src="`+ img +`" class="card-img-top">
                                                        <div class="bg-success text-white pl-1 pr-1" style="font-size: 9pt">
                                                            `+ rating +`
    ...
    function handle_popular_movie()
    {
        $.ajax({
            url: base_url+`curl/popular_movies/${page}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                ...
                if(page == 1)
                {
                    $('#page_popular_movie').html(`<ul class="pagination justify-content-center">
                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/popular/page/'+hal+`">`+ hal +`</a></li>
                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/popular/page/'+next+`">`+ next +`</a></li>
                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/popular/page/'+next+`">Next</a></li>
                                    </ul>`);
                }else
                {
                    ...
                    {
                        $('#page_popular_movie').html(`<ul class="pagination justify-content-center">
                                            <li class="page-item"><a class="page-link" href="`+ base_url +'movie/popular/page/'+prev+`">Previous</a></li>
                                            <li class="page-item"><a class="page-link" href="`+ base_url +'movie/popular/page/'+prev+`">`+ prev +`</a></li>
                                            <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/popular/page/'+hal+`">`+ hal +`</a></li>
                                            <li class="page-item"><a class="page-link" href="`+ base_url +'movie/popular/page/'+next+`">`+ next +`</a></li>
                                            <li class="page-item"><a class="page-link" href="`+ base_url +'movie/popular/page/'+next+`">Next</a></li>
                                        </ul>`);
                ...
                $.each(data, function(i)
                {
                    ...
                    var genres = data[i].genres;
                    var genre = String(genres);
                    $('#popular_movie').append(`<div class="col p-1">
                                                    <div class="card h-100">
                                                        <img src="`+ img +`" class="card-img-top">
                                                        <div class="bg-success text-white pl-1 pr-1" style="font-size: 9pt">
                                                            `+ rating +`
    ...
    {
        $.ajax({
            url: base_url+`curl/recent_movies/${page}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                ...
                if(page == 1)
                {
                    $('#page_recent_movie').html(`<ul class="pagination justify-content-center">
                                                    <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/recent-release/page/'+hal+`">`+ hal +`</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/recent-release/page/'+next+`">`+ next +`</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/recent-release/page/'+next+`">Next</a></li>
                                                </ul>`);
                }else
                {
                    ...
                    {
                        $('#page_recent_movie').html(`<ul class="pagination justify-content-center">
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/recent-release/page/'+prev+`">Previous</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/recent-release/page/'+prev+`">`+ prev +`</a></li>
                                                        <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/recent-release/page/'+hal+`">`+ hal +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/recent-release/page/'+next+`">`+ next +`</a></li>
                                                        <li class="page-item"><a class="page-link" href="`+ base_url +'movie/recent-release/page/'+next+`">Next</a></li>
                                                    </ul>`);
                ...
                $.each(data, function(i)
                {
                    ...
                    var genres = data[i].genres;
                    var genre = String(genres);
                    $('#recent_movie_content').append(`<div class="col p-1">
                                                    <div class="card h-100">
                                                        <img src="`+ img +`" class="card-img-top">
                                                        <div class="bg-success text-white pl-1 pr-1" style="font-size: 9pt">
                                                            `+ rating +`
    ...
    function handle_countries()
    {
        var id = '<?= $this->uri->segment('3'); ?>';
        var pages = '<?= $this->uri->segment('5'); ?>';
        if(!pages)
        {
            pages = 1;
        }
        ...
        $.ajax({
            url: base_url+`curl/countrie/${id}/${pages}`,
            type: 'get',
            dataType: 'json',
            beforeSend: function()
            {
            ...
            success: function (data) 
            {
                ...
                if(pages == 1)
                {
                    $('#page_countries').html(`<ul class="pagination justify-content-center">
                                                <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/countries/'+id+'/page/'+hal+`">`+ hal +`</a></li>
                                                <li class="page-item"><a class="page-link" href="`+ base_url +'movie/countries/'+id+'/page/'+next+`">`+ next +`</a></li>
                                                <li class="page-item"><a class="page-link" href="`+ base_url +'movie/countries/'+id+'/page/'+next+`">Next</a></li>
                                            </ul>`);
                }else
                {
                    ...
                    {
                        $('#page_countries').html(`<ul class="pagination justify-content-center">
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/countries/'+id+'/page/'+prev+`">Previous</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/countries/'+id+'/page/'+prev+`">`+ prev +`</a></li>
                                                    <li class="page-item active"><a class="page-link" href="`+ base_url +'movie/countries/'+id+'/page/'+hal+`">`+ hal +`</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/countries/'+id+'/page/'+next+`">`+ next +`</a></li>
                                                    <li class="page-item"><a class="page-link" href="`+ base_url +'movie/countries/'+id+'/page/'+next+`">Next</a></li>
                                                </ul>`);
                ...
                $.each(data, function(i)
                {
                    ...
                    var genres = data[i].genres;
                    var genre = String(genres);
                    $('#countries').append(`<div class="col p-1">
                                                <div class="card h-100">
                                                    <img src="`+ img +`" class="card-img-top">
                                                    <div class="bg-success text-white pl-1 pr-1" style="font-size: 9pt">
                                                        `+ rating +`
    ...
    {
        $('#latest_movie, #popular_movie, #recent_movie_content, #recent_movie, #recent_series, #countries, #top_movie').on('click', '.trailer', function () {
            var id = $(this).data('id');      
